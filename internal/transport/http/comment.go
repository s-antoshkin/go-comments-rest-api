...
type CommentService interface {
	...
	GetComment(cmt context.Context, id string) (comment.Comment, error)
	UpdateComment(cmt context.Context, id string, newCmt comment.Comment) (comment.Comment, error)
	DeleteComment(cmt context.Context, id string) error
}
...
func converPostCommentRequestToComment(p PostCommentRequest) comment.Comment {
...
func (h *Handler) PostComment(w http.ResponseWriter, r *http.Request) {
	...
	convertedComment := converPostCommentRequestToComment(cmt)
